...
const categories = [
  ...
  },
  {
    ...
    skills: ['Node.js', 'Express.js', 'PHP', 'MySQL', 'PostgreSQL', 'Supabase', 'REST APIs'],
  },
  {
  ...
  },
  {
    ...
    skills: ['Responsive UI', 'API Integration', 'Data Visualisation', 'Performance Optimisation', 'Accessibility'],
  },
]
